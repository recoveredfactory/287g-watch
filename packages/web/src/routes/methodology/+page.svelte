...
<main id="main-content" class="mx-auto max-w-3xl px-4 py-8 sm:py-12 sm:px-6">
  <h1 class="text-2xl font-black text-ink-900 sm:text-4xl">{m.methodology_heading()}</h1>

  <div class="prose-editorial mt-6 sm:mt-8">
    <h2 class="font-serif text-xl font-bold text-ink-900 sm:text-2xl">{m.methodology_sources_heading()}</h2>
    ...
    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_matching_heading()}</h2>

    <p class="mt-3"><Gloss text={m.methodology_matching_body()} {seen} /></p>

    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_mapping_heading()}</h2>

    <p class="mt-3"><Gloss text={m.methodology_mapping_body()} {seen} /></p>
    <p class="mt-3"><Gloss text={m.methodology_mapping_statewide()} {seen} /></p>

    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_population_heading()}</h2>
    ...
    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_limitations_heading()}</h2>
    ...
    <h2 id="agreements" class="mt-8 scroll-mt-24 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_moa_heading()}</h2>

    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_moa_coverage_heading()}</h3>
    <p class="mt-3"><Gloss text={m.methodology_moa_coverage_body()} {seen} /></p>

    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_moa_signers_heading()}</h3>
    <p class="mt-3"><Gloss text={m.methodology_moa_signers_body()} {seen} /></p>

    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_moa_timeline_heading()}</h3>
    ...
    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_moa_caveats_heading()}</h3>
    <ul class="mt-3">
    ...
    <h2 id="ai" class="mt-8 scroll-mt-24 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_ai_heading()}</h2>

    <p class="mt-3"><Gloss text={m.methodology_ai_body_1()} {seen} /></p>
    <p class="mt-3"><Gloss text={m.methodology_ai_body_2()} {seen} /></p>

    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_news_gather_heading()}</h3>
    ...
    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_news_relevance_heading()}</h3>

    <p class="mt-3"><Gloss text={m.methodology_news_relevance_body()} {seen} /></p>

    <h3 class="mt-6 font-serif text-lg font-bold text-ink-900 sm:mt-8 sm:text-xl">{m.methodology_news_grounding_heading()}</h3>
    ...
    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_updates_heading()}</h2>

    <p class="mt-3"><Gloss text={m.methodology_updates_body()} {seen} /></p>

    <h2 class="mt-8 font-serif text-xl font-bold text-ink-900 sm:mt-10 sm:text-2xl">{m.methodology_license_heading()}</h2>
